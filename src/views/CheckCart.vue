      ...
      <div class="row">
                      ...
                      <div class="ms-3 text-start py-4">
                        ...
                        <div class="d-md-none">
                          <div class="input-group">
                            <button type="button" class="btn btn-outline-dark"><i class="bi bi-dash"></i></button>
                            <input type="number" class="form-control text-center border-dark bg-transparent" readonly />
                            <button type="button" class="btn btn-outline-dark"><i class="bi bi-plus"></i></button>
                          </div>
                        </div>
                      </div>
                    </td>
        ...
        <div class="col-12 col-lg-4 mb-4">
          <div class="border p-6">
            ...
            <div class="py-4"><span class="text-sm text-gray-400 mr-4">運費</span><span class="fs-4">NT$60</span></div>
            ...
            <div class="" v-if="cart.final_total !== cart.total">
            ...
            <button type="button" class="btn btn-dark w-100">填寫資料</button>
          </div>
        </div>
      </div>
    </div>
